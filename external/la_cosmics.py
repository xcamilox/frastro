...
from frastro.telescopes.telescopes import Telescopes
...
class CosmicsRayRemove:

    def __init__(self):
        pass

    def init(self, rawarray, pssl=0.0, gain=2.2, readnoise=10.0, sigclip=5.0, sigfrac=0.3, objlim=5.0,
    ...
    def fromfits(self,infilename, hdu=0, verbose=True):
        """
    ...
    def tofits(self,outfilename, pixelarray, hdr=None, verbose=True):
        """
    ...
    def subsample(self,a):  # this is more a generic function then a method ...
        """
    ...
    def cleanImage(self,fits_path,sigclip=5.0, sigfrac=0.3, objlim=5.0):

        tele_info = Telescopes.getTelescopeData(fits_path)
        array, header = self.fromfits(fits_path)
        # array is a 2D numpy array

        # Build the object :Liverpool config

        self.init(array, gain=tele_info["gain"], readnoise=tele_info["readnoise"], sigclip=sigclip, sigfrac=sigfrac, objlim=objlim)
        ...
        out_path=fits_path[:-5] + "_clean.fits"
        self.tofits(out_path, self.cleanarray, header)
        return out_path


if __name__ == "__main__":
    path = "/Users/cjimenez/Documents/PHD/data/liverpool_lens/SLACSJ1432+6317/h_e_20180801_28_1_1_1.fits"
    path = "/Users/cjimenez/Documents/PHD/data/liverpool_lens/SLACSJ0330-0020/h_e_20180814_25_1_1_1.fits"

    path="/Users/cjimenez/Documents/PHD/data/liverpool_lens/SLACSJ0330-0020/liverpool/h_e_20180814_25_1_1_1.fits"
    path="/Users/cjimenez/Documents/PHD/data/liverpool_lens/SLACSJ0330-0020/liverpool/h_e_20180816_75_1_1_1.fits"
    path="/Users/cjimenez/Documents/PHD/data/liverpool_lens/SLACSJ0330-0020/liverpool/h_e_20180816_75_2_1_1.fits"
    path="/Users/cjimenez/Documents/PHD/data/liverpool_lens/SLACSJ0330-0020/liverpool/h_e_20180816_75_3_1_1.fits"
    path="/Users/cjimenez/Documents/PHD/data/liverpool_lens/S4TMJ0143-1006/observations/2018-08-10/h_e_20180809_82_1_1_1.fits"

    cosmics = CosmicsRayRemove()
    cosmics.cleanImage(path)

    """
    array, header = cosmics.fromfits(path)
    # array is a 2D numpy array

    # Build the object :Liverpool config

    cosmics.init(array, gain=1.5, readnoise=15.0, sigclip=5.0, sigfrac=0.3, objlim=5.0)
    # There are other options, check the manual...

    # Run the full artillery :
    cosmics.run(maxiter=4)

    # Write the cleaned image into a new FITS file, conserving the original header :
    cosmics.tofits(path+"_clean.fits", cosmics.cleanarray, header)

    # If you want the mask, here it is :
    cosmics.tofits(path+"_mask.fits", cosmics.mask, header)
